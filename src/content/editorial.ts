...
export const reviewCopy: Record<string, ReviewCopy> = {
  "litelok-x1": {
    hook: "A Sold Secure Diamond D-lock that weighs 1.7 kg.",
    job: "This is a good option if your insurance requires Diamond and you’re prepared to carry a 1.7kg lock.",
    meta: "Litelok X1 review: Sold Secure Diamond for ordinary bikes and e-bikes, 1.7 kg, 101 × 197 mm locking area. Based on published grades and specs, not a cut test.",
    verdict:
      "The X1 is Sold Secure Diamond for ordinary bikes and for e-bikes. It weighs 1.7 kg and has a 101 × 197 mm locking area. This is worth considering if your insurance requires Diamond and you regularly leave an expensive bike in public. If Gold is enough for your policy, the extra weight may not be worthwhile — and the Evolution Mini-7 adds a clip and a cable in one kit. There is no frame mount in the box we looked at, so you will need a bag or a separate mount.",
    subheads: [
    ...
    body: [
      "Sold Secure lists this lock as Diamond for ordinary bikes and for e-bikes. At 1.7 kg it sits in a weight band many people will still take to work, which matters as much as the grade. A heavier lock left at home does not protect the bike at the stand.",
      ...
      "On the Amazon listing we looked at, the frame mount is sold separately. Budget for a mount or a bag, or be honest that you will carry 1.7 kg by hand. Riders who know they will only use a lock that clips to the bike often prefer the Evolution Mini-7 for that reason alone.",
  ...
  "hiplok-d1000": {
    ...
    job: "Worth considering for high-theft streets once you have measured the stand and confirmed the small shackle will close.",
    meta: "Hiplok D1000 review: Sold Secure Diamond, 1.9 kg, 92 × 155 mm locking area, no frame mount. Measure the stand first. Based on grades and specs, not a cut test.",
    verdict:
      "The D1000 is Sold Secure Diamond for ordinary bikes and for e-bikes. It weighs 1.9 kg, has a 92 × 155 mm locking area, and comes without a frame mount on the listing we looked at. That compact shackle is the main thing to check before you buy. If it will not close around your stand and frame, the grade does not help. Riders whose insurance still asks for Gold, and who want a mount and a cable, are usually better served by the Evolution Mini-7.",
    subheads: [
    ...
    body: [
      ...
      "There is no frame mount in the box we looked at. You would need to carry 1.9 kg in a bag, or leave it at home. For a weekday commuter whose insurance still asks for Gold, the Evolution Mini-7 is lighter, includes a mount, and comes with a cable.",
      ...
      "Hiplok’s larger DX1000 (112 × 205 mm, 2.75 kg) is the sibling if the compact shackle is the problem. It is also Diamond for ordinary bikes and for e-bikes, still with no frame mount, and 850 g heavier. If you wanted Diamond with a more usable locking area at 1.7 kg, look at the Litelok X1. Choose the D1000 only after you have stood next to the rack with a tape measure.",
    ],
    bestFor: [
    ...
    faqs: [
      {
        q: "D1000 or DX1000?",
        a: "The D1000 has a 92 × 155 mm locking area and weighs 1.9 kg. The DX1000 has a 112 × 205 mm locking area and weighs 2.75 kg. Choose the one that closes on your stand. Do not guess from a product photo. Full DX1000 write-up: [Hiplok DX1000](/reviews/hiplok-dx1000).",
      },
      {
  ...
  "kryptonite-evolution-mini-7": {
    ...
    meta: "Kryptonite Evolution Mini-7 review: Sold Secure Gold, 1.61 kg, frame mount and cable in the box. The cable is not Gold. Based on published grades and specs.",
    verdict:
    ...
    body: [
      "This lock is aimed at daily commuting. It weighs 1.61 kg and includes a frame mount, three keys, and a loop cable. Because it clips to the bike, you are more likely to have it with you at the stand.",
      ...
      "Gold is still the grade a lot of UK household cycle insurance names. Diamond is higher, and some e-bike policies want the e-bike version of that grade. If that is your situation, look elsewhere. If Gold is what the policy asks for and you will carry 1.6 kg, this kit fits that job well. If you need Gold with more reach than 83 × 178 mm, the Bordo 6500 offers 110 cm of folding length at a higher weight.",
      "The New York Fahgettaboudit Mini is the thicker sibling: 18 mm, 2.06 kg, no mount, no cable, still only Gold. People search it because of the name. Most commuters are better with this Evolution Mini-7. The extra thickness is not usually worth an extra 450 g every day when the Sold Secure grade is the same.",
    ],
    bestFor: [
  ...
  "abus-granit-xplus-540": {
    ...
    body: [
      ...
      "The frame mount is in the box we looked at. At 1.8 kg on the frame, you are more likely to have it with you in the morning. There is no cable in this box. Do not assume an ABUS cable kit from another product.",
    ...
    bestFor: [
      ...
      "Commuters who will put 1.8 kg on the frame",
    ],
    skipIf: [
  ...
  "kryptonite-new-york-fahgettaboudit-mini": {
    hook: "An 18 mm Sold Secure Gold compact D-lock at 2.06 kg, without a frame mount.",
    ...
    meta: "Kryptonite New York Mini review: 18 mm Gold compact D-lock, 2.06 kg, no frame mount, no cable. A thick second lock. Based on published grades and specs.",
    verdict:
      "This can work as a small, thick Gold D-lock you leave on a heavy bike or at a regular stand. It is a poorer fit as your only commute lock if 1.6 kg already feels like too much. Specs: 2.06 kg, 83 × 153 mm locking area, no frame mount, and no cable. In this family, the Evolution Mini-7 is usually easier to take every day, because it is lighter and includes a mount and a cable.",
    subheads: [
    ...
    body: [
      "The Fahgettaboudit name is branding. What you get is an 18 mm Gold compact D-lock with a smaller locking area than the Evolution Mini-7 and 450 g more steel. There is no frame mount in the box we looked at, and no cable, so you carry 2.06 kg by hand or strap it somehow.",
  ...
  "kryptonite-new-york-fahgettaboudit-1410": {
    hook: "A Sold Secure Gold chain, 100 cm long, listed at 4.9 kg.",
    job: "The 4.9kg weight makes this much more suitable for use at home than for a daily commute.",
    meta: "Kryptonite New York 1410 chain review: 100 cm, 14 mm, 4.9 kg, Gold grade. Extra length for home or a terrace. Based on published grades and specs.",
    verdict:
      "This suits home, garden, or café-terrace use when a D-lock will not reach the only solid object. The 4.9 kg weight, with no mount, makes it a poor daily commute lock. Sold Secure Gold applies to the approved product; looping the chain twice does not change the grade. Leave this where the bike is stored overnight and take a D-lock when you ride away.",
    subheads: [
      "Reach versus carry",
      "The listed weight is 4.9 kg",
      "Gold grade, and what looping twice does not change",
      "Using it with a commute D-lock",
    ],
    body: [
      "A D-lock suits a tight stand. A chain suits extra length. 100 cm of 14 mm New York chain will reach a ground anchor, a second bike, or a post a compact D-lock cannot close around. The 4.9 kg weight makes it much more suitable to leave at home than to carry in a backpack every day.",
    ...
    bad: [
      "4.9 kg — useful where the bike is stored, awkward as a daily carry",
    ...
    altSecond: "litelok-x1",
    altSecondWhy: "You need Diamond on a lock you still have to carry: 1.7 kg, on the bike.",
  },
  "hiplok-dx1000": {
    ...
    body: [
      ...
      "There is no frame mount in the box we looked at. You carry 2.75 kg in a bag, or you leave it at home. A Diamond lock on the kitchen floor does not protect the bike at the stand. If you already know you will only use a lock that clips on, look at the Pitbull STD: Diamond for ordinary bikes, 1.44 kg, a mount in the box.",
      ...
      "If you wanted Diamond you will still carry at 1.7 kg, that is the X1. If 92 × 155 mm already closes, the D1000 is the lighter Hiplok. If you need a long shackle and a mount, the Pitbull LS or the 540 will close on posts this one will not.",
    ],
    bestFor: [
    ...
    change:
      "A frame mount in the box would help. At 2.75 kg this is the Hiplok most likely to stay in the hall.",
    faqs: [
      {
        q: "D1000 or DX1000?",
        a: "The D1000 is 92 × 155 mm and 1.9 kg. The DX1000 is 112 × 205 mm and 2.75 kg. Same Diamond grade for ordinary bikes and e-bikes, still no mount. Choose the one that closes. Full D1000 write-up: [Hiplok D1000](/reviews/hiplok-d1000).",
      },
      {
  ...
  "onguard-pitbull-std-8003": {
    ...
    job: "Worth considering if you need Diamond and want a frame mount. Its larger locking area also gives you more room than the Mini-7.",
    meta: "OnGuard Pitbull STD 8003 review: Sold Secure Diamond for ordinary bikes, 1.44 kg, frame mount, 115 × 230 mm. Worth considering if you need Diamond with a clip. Based on published grades and specs.",
    stamp: "Diamond (ordinary bikes)",
    verdict:
      "This suits riders whose policy names Diamond and who will not take a lock that does not clip to the bike. Specs on our records: 1.44 kg, 14 mm shackle, 115 × 230 mm locking area, a frame mount, five keys, no cable. The ordinary-bike grade is Diamond. We do not have an e-bike grade listed, so if the policy names powered Diamond, check Sold Secure and the insurer’s list before you treat this as an e-bike lock. It is not sold as anti-grinder.",
    subheads: [
    ...
    body: [
      "The X1 and the D1000 are Diamond locks you typically carry in a bag. This Pitbull is worth considering if you want Diamond security but also want to carry the lock on the bike. At 1.44 kg it is lighter than the Mini-7, and the mount is in the box we looked at. That combination is why it sits on the best-of table: if you need Diamond and you already know you will not take a loose lock every morning, start here.",
    ...
    faqs: [
      ...
      {
        q: "STD or DT 8005?",
        a: "Same 14 mm shackle, same 115 × 230 mm locking area, same mount. The DT adds a cable and is listed at 1.6 kg. The cable is not Diamond. Choose the STD unless you want that cable in the box.",
      },
      {
    ...
    altSecond: "litelok-x1",
    altSecondWhy: "The policy names e-bike Diamond, or you want the armoured lock when you will still carry 1.7 kg in a bag.",
  },
  "onguard-pitbull-dt-8005": {
    ...
    stamp: "Diamond (ordinary bikes)",
    verdict:
      "Choose this when you want the STD Pitbull’s Diamond D-lock and you also want a wheel cable in the same box. The D-lock is Sold Secure Diamond for ordinary bikes on our records. The cable is not part of that grade — same rule as the Mini-7’s cable. Specs: 1.6 kg, 14 mm, 115 × 230 mm, a frame mount, five keys. If you do not need the cable, the STD is lighter.",
    subheads: [
    ...
    body: [
      ...
      "The frame mount is in the box we looked at, at 1.6 kg, with five keys. No anti-grinder claim on our records. If Gold is enough, the Evolution Mini-7 sits in the same weight band with a cable. If you need Diamond without the cable, choose the STD. If you need Diamond for an e-bike policy, check this model on Sold Secure — the X1 is Diamond for both on our records.",
    ],
    bestFor: [
    ...
    faqs: [
      ...
      {
        q: "DT or STD 8003?",
        a: "Same 14 mm shackle, same 115 × 230 mm locking area, same mount. The DT is listed at 1.6 kg with a cable. The STD is 1.44 kg with no cable. Choose the STD unless you want that cable in the box.",
      },
      {
  ...
  "onguard-pitbull-ls-8002": {
    ...
    meta: "OnGuard Pitbull LS 8002 review: Sold Secure Diamond for ordinary bikes, long 115 × 292 mm shackle, 1.75 kg, frame mount. For fat posts and cargo when a Mini will not close.",
    stamp: "Diamond (ordinary bikes)",
    verdict:
      "This helps when a compact Diamond will not close and you still want a mount. 115 × 292 mm is in the same band as the ABUS 540’s 108 × 300 mm. Specs: 1.75 kg, 14 mm, five keys, no cable, frame mount in the box we looked at. On our records the ordinary-bike grade is Diamond; we do not have an e-bike grade listed. The 540 is Diamond for ordinary bikes and Gold for e-bikes, with a slightly longer shackle. Pick this if you want the Pitbull mount-and-keys kit on a long shackle.",
    subheads: [
    ...
    body: [
      ...
      "The 540 is 108 × 300 mm, 1.8 kg, two keys, EaZy KF bracket, no cable. This LS is 115 × 292 mm, 1.75 kg, five keys, a mount, no cable. Neither is sold as anti-grinder. Choose on cylinder, keys, and the e-bike line — after you have measured. If you wanted Hiplok’s larger anti-grinder lock, the DX1000 is 112 × 205 mm: more room than the D1000, not this much length.",
      "The frame mount is in the box we looked at. 1.75 kg on the frame is a lock you are more likely to have with you. There is no cable. A longer shackle also gives a thief more room for a tool. Fill it: frame plus rear wheel if they both fit, tight to the stand. If a Mini already closes on your stand, you do not need this length — choose the STD, or the Mini-7 if Gold is enough. If you need a metre of chain at home, that is the New York 1410.",
    ],
    bestFor: [
    ...
    faqs: [
      ...
      {
        q: "LS or STD 8003?",
        a: "Same 14 mm family, same mount, same ordinary-bike Diamond on our records. The STD is 115 × 230 mm at 1.44 kg. The LS is 115 × 292 mm at 1.75 kg. Choose the STD if a compact lock already closes. Choose the LS if it does not.",
      },
      {
  ...
  "abus-bordo-granit-xplus-6500": {
    ...
    job: "A good option when Gold is enough, a Mini will not reach the stand, and you still want the lock clipped to the bike rather than leaving a chain at home.",
    ...
    verdict:
      "This suits riders when Gold meets the policy, a compact D-lock will not reach the only solid object, and you still want the lock on the bike rather than a 4.9 kg chain at home. Specs: 110 cm of folding bars, 2.16 kg, SH bracket on the listing we looked at, two keys. That is 550 g more than the Mini-7, and a different shape: 5.5 mm bars, not a 13 mm D-shackle. Gold is Gold; the shape is not Diamond. Prefer the Mini-7 for a classic Gold commute that already closes. Prefer this when the extra reach is the point.",
    subheads: [
    ...
    body: [
      ...
      "2.16 kg with an SH bracket is a commute lock only if you will fit the bracket and use it. That is a lot of lock on a down tube. If 1.6 kg already feels like too much, this will stay at home. The Mini-7 is the lighter Gold lock with a clip and a cable.",
...
export const catalogueHooks: Record<string, string> = {
  "litelok-x1": "A good choice when you need Diamond for a higher-value bike but still need to carry the lock to work.",
  ...
  "onguard-pitbull-std-8003": "Worth considering if you need Diamond and want a frame mount.",
