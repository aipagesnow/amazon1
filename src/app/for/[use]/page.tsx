...
const CASES: UseCase[] = [
  ...
  },
  {
    ...
    body: [
      ...
      "On our records: Evolution Mini-7 and the New York Mini and 1410 chain are Gold for pedal cycles. Litelok X1 and Hiplok D1000 are Diamond for both pedal and powered. The ABUS 540 is pedal Diamond and powered Gold — the wrong way round if your e-bike policy wants powered Diamond.",
